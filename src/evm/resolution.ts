...
export async function getRecordsResolution(domainName: string, ethProviderUrl: string, polygonProviderUrl: string) {
    try {
...
async function getRecord(resolution: Resolution, domain: string, recordKey: string): Promise<any> {
    try {
